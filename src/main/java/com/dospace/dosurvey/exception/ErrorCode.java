...
public enum ErrorCode {
        ...
        FORM_CATEGORY_STILL_IN_USE(400, "The form category is still in use by non-deleted forms.",
        ...
        FORM_RESPONSE_QUESTION_NOT_FOUND(404, "Question not found in the response, please check the ID.",
        ...
        INVALID_TENANT_SETTING(400, "Cannot update tenant access for a form that does not belong to the tenant.",
                        HttpStatus.BAD_REQUEST),
        INVALID_NAVIGATION_TARGET(400, "Invalid navigation target. Must be 'NEXT', 'SUBMIT', or valid pageId.",
                        HttpStatus.BAD_REQUEST),
